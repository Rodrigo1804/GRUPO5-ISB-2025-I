...
| **Filtro FIR - Hamming** |El filtrado reduce bien el ruido de alta frecuencia y deja una señal suave, coherente con el reposo con ojos abiertos donde predomina la actividad alfa leve y poco artefacto muscular.| SSe observan oscilaciones de mayor amplitud y lentitud, típico del cierre ocular que potencia la actividad alfa, y el filtro mantiene bien la forma sin distorsiones. | Se preserva la actividad muscular relevante mientras que se elimina la mayor parte del ruido de movimiento. | dasdsadsasd | sdasdsadsadasd |
