...
| **Filtro FIR - Hamming** |Se muestra una reducción significativa de componentes de alta frecuencia, logrando una forma de onda suavizada y más clara respecto a la "raw-signal". Esto es un comportamiento que sí esperamos con la actividad de reposo con ojos abiertos, donde se espera una señal con predominio de ritmos alpha atenuados y presencia de ruido muscular mínima. El filtro FIR con ventana de Hamming ha demostrado buena atenuación fuera de banda sin distorsión de fase.| Se nota una actividad más marcada en amplitud y ciertas oscilaciones lentas, algo esperado ya que cerrar los ojos tiende a aumentar la actividad alfa en regiones occipitales. El filtro FIR con esta ventana suaviza bien la señal sin deformar la forma de onda, lo que permite distinguir las variaciones sin introducir mucho ruido. Si es que la comparamos con "Basal 1", parece que el sujeto estuvo más relajado o con menos estimulación visual, lo cual concuerda con la actividad misma. | Se preserva la actividad muscular relevante mientras que se elimina la mayor parte del ruido de movimiento. | dasdsadsasd | sdasdsadsadasd |
| **Filtro FIR - Bartlett**  | A pesar de que la transición sea más rápida que el de Butterworth y una posible distorsión de la señal por la presencia de ripples, no se puede observar una diferencia significativa. |  Se mantiene la respuesta muscular, lo que indica una contracción leve. Sin embargo, no se observar una diferencia significativa. |  La contracción fuerte se conserva muy bien. Se puede notar ligeramente cierta diferencia en la forma de la señal en algunas zonas y se puede deber a la presencia de ripples en la banda de paso. | dasdsadsasd | sdasdsadsadasd |
| **Filtro IIR - Butterworth** | La señal presenta una amplitud menor comparada con la cruda, con una transición más suave en las frecuencias. | La contracción leve muestra un buen filtrado, eliminando las frecuencias fuera del rango establecido y se puede notar la presencia de la respuesta muscular. |  Se puede observar que el filtro permite una buena preservación de la contracción fuerte, aunque las frecuencias fuera de rango se atenúan progresivamente. | dasdsadsasd | sdasdsadsadasd |
| **Filtro IIR - Chebyshev**  | Se redujo el ruido pero no se puede apreciar una diferencia notable con el Butterworth | Se mantiene la respuesta muscular, lo que indica una contracción leve. Sin embargo, no se observa una diferencia significativa con el Butterworth. | Se conserva la amplitud de la contracción fuerte , aunque los ripples en la banda de paso están afectando algunos picos altos en la señal. | dasdsadsasd | sdasdsadsadasd |
